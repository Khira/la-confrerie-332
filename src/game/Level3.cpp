...
bool ChatHandler::HandleReloadAchievementCriteriaRequirementCommand(const char*)
{
    ...
    SendSysMessage("DB table `achievement_criteria_requirement` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadAchievementRewardCommand(const char*)
{
    ...
    SendSysMessage("DB table `achievement_reward` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadLootTemplatesMillingCommand(const char*)
{
    ...
    SendSysMessage("DB table `milling_loot_template` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadLootTemplatesProspectingCommand(const char*)
{
    ...
    SendSysMessage("DB table `prospecting_loot_template` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadLootTemplatesSpellCommand(const char*)
{
    ...
    SendSysMessage("DB table `spell_loot_template` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadSpellClickSpellsCommand(const char*)
{
    ...
    SendSysMessage("DB table `npc_spellclick_spells` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadLocalesAchievementRewardCommand(const char*)
{
    ...
    SendSysMessage("DB table `locales_achievement_reward` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadMailLevelRewardCommand(const char* /*arg*/)
{
    ...
    SendSysMessage("DB table `mail_level_reward` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadSpellDisabledCommand(const char* /*arg*/)
{
    ...
    SendSysMessage("DB table `spell_disabled` reloaded.");
...
bool ChatHandler::HandleLoadScriptsCommand(const char* args)
{
    ...
    SendSysMessage("DB `scriptdev2` reloaded.");
    return true;
}
